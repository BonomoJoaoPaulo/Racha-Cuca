...
solucao(ListaSolucao) :- 
    ...
    exatamenteaEsquerda(equipe(_, _, _, 4, _, _), equipe(_, _, _, _, _, 380), ListaSolucao),
    ...
    exatamenteaDireita(equipe(_, _, oscar, _, _, _), equipe(_, _, _, _, 23, _), ListaSolucao),
    ...
    exatamenteaDireita(equipe(_, _, _, _, _, 390), equipe(_, _, _, 3, _, _), ListaSolucao),
    ...
    exatamenteaDireita(equipe(_, _, juliano, _, _, _), equipe(_, _, oscar, _, _, _), ListaSolucao),
    ...
    exatamenteaEsquerda(equipe(_, _, _, 1, _, _), equipe(_, catorzebiz, _, _, _, _), ListaSolucao),
    ...
    exatamenteaEsquerda(equipe(branco, _, _, _, _, _), equipe(verde, _, _, _, _, _), ListaSolucao),
    
    % A equipe com 390 pontos está exatamente à esquerda da equipe Azul.
    exatamenteaEsquerda(equipe(_, _, _, _, _, 390), equipe(azul, _, _, _, _, _), ListaSolucao),
